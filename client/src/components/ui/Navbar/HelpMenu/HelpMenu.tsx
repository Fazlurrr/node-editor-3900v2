    ...
    return(
        <>
          ...
          <div className='flex justify-between items-center mb-4 p-2 pl-4 border-b border-[#9facbc] font-bold'>
              {currentPage === 'Tutorial' ? 'Tutorial' : currentPage === 'Credits' ? 'Credits' : currentPage === 'KeyboardShortcuts' ? 'Keyboard Shortcuts' : currentPage === 'Guru' ? 'Guru' : ''}
